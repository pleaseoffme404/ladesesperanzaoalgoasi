    ...
    async function loadProfile() {
        try {
            ...
            if (response.success) {
                ...
                profilePicPreview.src = user.imagen_perfil_url || '/assets/images/perfil/default-avatar.png';
                profilePicUrlActual.value = user.imagen_perfil_url || '';
            }
        } catch (error) {
    ...
    profileForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (data.success) {
                ...
                document.getElementById('profile-pic-btn').src = data.nuevaImagenUrl;
            }
        } catch (error) {
        ...
        card.innerHTML = `
            ...
            <div class="product-info">
                ...
                <div class="product-footer" style="align-items: center;">
                    ...
                    <button class="remove-favorito-btn" data-id="${product.id_producto}" style="background:none; border:none; cursor:pointer; color: #e74c3c;">Eliminar</button>
                </div>
            </div>
        `;
